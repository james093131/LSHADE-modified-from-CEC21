...
void searchAlgorithm::evaluatePopulation(const vector<Individual> &pop, vector<Fitness> &fitness) {
  for (int i = 0; i < pop_size; i++) {
    // if(F_T == 1)
    // {
    //   cec21_basic_func(pop[i],  &fitness[i], problem_size, 1, function_number);//1
    // }
    // else if(F_T==2)
    // {
    //   cec21_bias_func(pop[i],  &fitness[i], problem_size, 1, function_number);//2
    //   fitness[i] = cec21_fitness_error(function_number,fitness[i]);
    // }
    // else if(F_T==3)
    // {
    //   cec21_shift_func(pop[i],  &fitness[i], problem_size, 1, function_number);//3
    // }
    // else if(F_T==4)
    // {
    //   cec21_rot_func(pop[i],  &fitness[i], problem_size, 1, function_number);//4
    // }
    // else if(F_T==5)
    // {
    //   cec21_bias_shift_func(pop[i],  &fitness[i], problem_size, 1, function_number);//5
    //   fitness[i] = cec21_fitness_error(function_number,fitness[i]);
    // }
    // else if(F_T==6)
    // {
    //   cec21_bias_rot_func(pop[i],  &fitness[i], problem_size, 1, function_number);//6
    //   fitness[i] = cec21_fitness_error(function_number,fitness[i]);
    // }
    // else if(F_T==7)
    // {
    //   cec21_shift_rot_func(pop[i],  &fitness[i], problem_size, 1, function_number);//7
    // }
    // else if(F_T==8)
    // {
    //   cec21_bias_shift_rot_func(pop[i],  &fitness[i], problem_size, 1, function_number);//8
    //   fitness[i] = cec21_fitness_error(function_number,fitness[i]);
    // }
    if(F_T==0)
    {
      cec17_test_func(pop[i],  &fitness[i], problem_size, 1, function_number);//cec2017
      fitness[i] -= 100.0*function_number;
    }
  }
}
